"""Tests for Agent B v0.1 — archived deterministic quant script."""
...
pytestmark = pytest.mark.skip(reason="archived v0.1 — replaced by Second Tower (agent_b v0.2)")

from pipeline.agents.archive.agent_b_v0_1 import (
